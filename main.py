...
def main():
	...
	##CandleFetcher.cut_table(table_names.BTC_14400, date_to_timestamp("2016-1-1"), date_to_timestamp("2016-6-1"))
	##CandleFetcher.cut_table(table_names.ETH_14400, date_to_timestamp("2016-1-1"), date_to_timestamp("2016-6-1"))
	##CandleFetcher.cut_table(table_names.XMR_14400, date_to_timestamp("2016-1-1"), date_to_timestamp("2016-6-1"))
	...
	##optimize(table_names.SMALL_HALF1_14400)
	##optimize(tn1_1800)
