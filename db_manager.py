...
class DBManager:
	...
	def create_data_table(self, data_name):
		...
		cursor.execute('CREATE TABLE {tn} ({nf_id} {ft_i} PRIMARY KEY {nn} AUTO_INCREMENT, {nf_date} {ft_i} {nn}, {nf_high} {ft_r} {nn}, {nf_low} {ft_r} {nn}, {nf_open} {ft_r} {nn}, {nf_close} {ft_r} {nn}, {nf_volume} {ft_r} {nn}, {nf_qVol} {ft_r} {nn}, {nf_wAvg} {ft_r} {nn})'\
